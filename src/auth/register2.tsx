...
import { Inreg2, login, register } from "../service/Service";
...
const Register2: Component<TestProps> = (props: any) => {
  ...
  const hasil1 = async () => {
    ...
    // // // console.log("institution ->", inputValue());
    // // // console.log("degree ->", inputValue1());
    // // // console.log("Major ->", inputValue2());
    // // // console.log("GPA ->", inputValue3());
 ...
 <a link href="#/journey" class="nav active" aria-current="page">Project</a>
            ...
            <div class="in">
                <input type="text" placeholder="Institution" class="input input-bordered" style="width:1230px; height:50px; border: 1px solid #545454;"onchange={(f) => { setInputValue(f.currentTarget.value);}} />
                <input type="text" placeholder="Degree" class="input input-bordered" style="width:1230px; height:50px; margin-top:3vh; border: 1px solid #545454;" onchange={(f) => { setInputValue1(f.currentTarget.value);}}/>
                <input type="text" placeholder="Major" class="input input-bordered" style="width:1230px; height:50px; margin-top:3vh; border: 1px solid #545454;"onchange={(f) => { setInputValue2(f.currentTarget.value);}} />
                <input type="text" placeholder="GPA" class="input input-bordered" style="width:1230px; height:50px; margin-top:3vh; border: 1px solid #545454;" onchange={(f) => { setInputValue3(f.currentTarget.value);}}/>
            ...
            <button class="btn-1 btn">
                <a link href="#/register3" class="inactive"onClick={hasil1}>Next</a>
            </button>
