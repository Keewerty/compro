...
const Career: Component<TestProps> = (props: any) => {

    return (
        <div> 
            
            {/* <div class="navbar bg-base-100">
                <div style="width:15%; align-self: self-end; display: flex; ">
                    <div class="logobc"></div>
                </div>
                <div class="navbarcarier">
                    <div class="flex-none; height: 5vh">
 ...
 <a link href="#/#section2" class="nav active"  aria-current="page" id="section1">Services</a>
   <a link href="#/training" class="nav active"  aria-current="page">Training Center</a>
            ...
            <div style="padding-top: 12vh;">
                <div class="career">
                    <div style="margin-left: 4vw;margin-top: 18vh;" class="career1 card-body">
                        <h1 class="career-task">Explore Life at Braincode!</h1>
                        <h1 class="career-task1">Find your passion, get your own dream job.Achieve your dream with BrainCode.</h1>
                        <a link href="#/professional" class="career-button btn btn-sm inactive">find jobs</a>
                    </div>
                </div>
            </div>

            <div>
                <h1 class="img-judul">Explore Opportunities</h1>
                <div class='wadah-img-judul' >
                    <div class='isi-img-judul'>
                        <div class="career-img1">
                            <div style="margin-left: 3vw;" class="card1 card-body">
                                <h1 class="card-titel">Professional</h1>
                                <h1 style="height:65%;" class="card-task">Professional positions come with competitive salary and generous benefits</h1>
                                <a link href="#/professional" class="inactive">
                                    <h1 class="card-button">Read More</h1>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class='wadah-career-img2'>
                        <div class="career-img2">
                            <div style="margin-left: 3vw;" class="card1 card-body">
                                <h1 class="card-titel">Internship</h1>
                                <h1 style="height:65%;" class="card-task">Braincode provides opportunities for students or fresh graduates to study internship</h1>
                                <a link href="#/internship" class="inactive">
                                    <h1 class="card-button">Read More</h1>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class='wadah-career-img3'>
                        <div class="career-img3">
                            <div style="margin-left: 3vw;" class="card1 card-body">
                                <h1 class="card-titel">Freelance</h1>
                                <h1 style="height:65%;" class="card-task">Braincode provides opportunities to work from anywhere as a Freelancer</h1>
                                <a link href="#/freelance" class="inactive">
                                    <h1 class="card-button">Read More</h1>
                                </a>
                            </div>
                        </div>
            ...
            <div>
                <div> 
               <label for="login-modal" class="career-button1 btn btn-sm"> Login and Apply Now</label>
                    <div style="display: flex;width: 100%;">
                        <div style="width: 28%; margin-left: 4vw;">
                            <div style=" margin-top: 4vw;" class="card-card card-body">
                                <div class="icon1"></div>
                                <div class="icon2"></div>
                                <h1 class="icon-task">Employees get a basic salary once a month in accordance with the responsibilities given.</h1>
                            </div>
                            <div style=" margin-top: 4vw;" class="card-card card-body">
                                <div class="icon1"></div>
                                <div class="icon3"></div>
                                <h1 class="icon-task">Employees get health benefits borne by the company</h1>
                            </div>
                        ...
                        <div style="width: 28%;"><div>
                            <div style="margin-left: 4vw; margin-top: 10vw;" class="card-img1"></div>
                        </div>
                        <div class="wadahcard-ats">
                            <div style="margin-top: -4vw; position: absolute;" class="card-card card-body">
                                <div class="icon1"></div>
                                <div class="icon4"></div>
                                <h1 class="icon-task">Employees get job training opportunities to improve their skills.</h1>
                            </div>
                            </div>
                            <div class="card-bwh">
                                <div class="iconbwh"></div>
                                <div class="icon5"></div>
                                <h1 class="icon-task-bwh">Employees who come from outside the Jakarta area,get a residence allowance that is home by the company.</h1>
                            </div>
                        </div>
                        <div style="width: 44%;">
                            <h1 class="life-title">Life at Braincode</h1>
                            <h1 class="life-sub">Braincode employees get many benefits and opportunities to improve their skills.Many benefits are provided ranging from health,operations,and residence.</h1>
                            <a link href="#/blog" class="life-button btn btn-sm inactive">Read Our Blogs</a>
                            <div class="card-img2">
                            </div>
                        </div>
                    </div>
